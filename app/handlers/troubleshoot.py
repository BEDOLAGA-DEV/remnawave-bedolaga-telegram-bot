...
SOLUTIONS: dict[str, dict[str, str]] = {
    'connect': {
        'ios': (
            ...
            '2. Переустановите приложение (v2rayNG / Streisand)\n'
        ...
        'android': (
            ...
            '2. Откройте v2rayNG → Удалите текущий профиль\n'
            '3. Импортируйте ссылку подписки заново\n'
    ...
    'slow': {
        ...
        'android': (
            ...
            '2. В v2rayNG попробуйте сменить протокол\n'
    ...
    'disconnect': {
        ...
        'android': (
            ...
            '4. Обновите v2rayNG до последней версии\n'
