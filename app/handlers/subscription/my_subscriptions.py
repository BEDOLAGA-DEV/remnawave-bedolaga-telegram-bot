...
def _build_subscriptions_keyboard(subscriptions: list, language: str) -> types.InlineKeyboardMarkup:
    ...
    buttons.append(
        [
            types.InlineKeyboardButton(text=f'➕ {buy_text}', callback_data='nz!_menu_buy'),
        ]
    )
    # Back button
    buttons.append(
...
def _build_subscription_detail_keyboard(sub_id: int, sub=None) -> types.InlineKeyboardMarkup:
    ...
    if not is_inactive:
        ...
        buttons.append([types.InlineKeyboardButton(text='💳 Автоплатеж', callback_data='nz!_subscription_autopay')])
...
async def show_my_subscriptions(
    ...
    if not subscriptions:
        ...
        keyboard = types.InlineKeyboardMarkup(
            inline_keyboard=[
                [types.InlineKeyboardButton(text='🛒 Купить подписку', callback_data='nz!_menu_buy')],
                [types.InlineKeyboardButton(text='◀️ Назад', callback_data='nz!_back_to_menu')],
            ]
        )
    else:
