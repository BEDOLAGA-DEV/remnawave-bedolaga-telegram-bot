...
def register_handlers(dp: Dispatcher):
    ...
    dp.callback_query.register(show_my_subscriptions, F.data == 'nz!_my_subscriptions')
    dp.callback_query.register(show_subscription_detail, F.data.startswith('nz!_sm:'))
    ...
    dp.callback_query.register(handle_change_devices_menu, F.data.startswith('nz!_change_devices_menu:'))
    dp.callback_query.register(handle_device_management_menu, F.data.startswith('nz!_device_management:'))
