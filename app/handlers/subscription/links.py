                ...
                keyboard.append(
                    [
                        types.InlineKeyboardButton(
                            ...
                            callback_data=f'nz!_sl:{sub.id}',
                        )
                    ]
                )
            keyboard.append([types.InlineKeyboardButton(text='◀️ Назад', callback_data='nz!_back_to_menu')])
...
🔗 Нажмите кнопку ниже, чтобы открыть ссылку подписки:""",
        ...
        rows = [
            [
                InlineKeyboardButton(
                    text=texts.t('CONNECT_BUTTON', '🔗 Подключиться'),
                    callback_data=f'nz!_open_subscription_link:{sub_id}'
        ...
        reply_markup=InlineKeyboardMarkup(
            inline_keyboard=[
                [
                    InlineKeyboardButton(
                        text=texts.t('CONNECT_BUTTON', '🔗 Подключиться'),
                        callback_data=f'nz!_subscription_connect:{sub_id}'
                        if settings.is_multi_tariff_enabled()
                        else 'nz!_subscription_connect',
                    )
                ],
                [InlineKeyboardButton(text=texts.BACK, callback_data=back_cb)],
            ]
