...
async def route_payment_by_method(
    ...
    if payment_method in ('kassa_ai', 'kassa_ai_sbp'):
...
def register_balance_handlers(dp: Dispatcher):
    ...
    from .kassa_ai import process_kassa_ai_quick_amount, process_kassa_ai_sbp_quick_amount, start_kassa_ai_sbp_topup, start_kassa_ai_topup
