...
# URL-ы
GITHUB_BOT_URL: Final[str] = 'https://github.com/NOZAPRET-DEV/remnawave-nozapret-telegram-bot'
GITHUB_CABINET_URL: Final[str] = 'https://github.com/NOZAPRET-DEV/nozapret-cabinet'
COMMUNITY_URL: Final[str] = ''
