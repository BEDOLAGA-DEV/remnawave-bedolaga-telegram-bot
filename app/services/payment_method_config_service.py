...
def _get_method_defaults() -> dict:
    ...
    return {
        ...
        'shkeeper': {
            'default_display_name': settings.get_shkeeper_display_name(),
            'is_configured': settings.is_shkeeper_enabled(),
            'default_min': settings.SHKEEPER_MIN_AMOUNT_KOPEKS,
            'default_max': settings.SHKEEPER_MAX_AMOUNT_KOPEKS,
            'available_sub_options': None,
        },
    }
