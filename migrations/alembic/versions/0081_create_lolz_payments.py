...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('lolz_invoice_id', sa.Integer(), unique=True, nullable=True, index=True),
        sa.Column('lolz_payment_id', sa.String(64), unique=True, nullable=True, index=True),
