...
- `tests/services/test_addon_cart_real_purchase.py` — Python-модуль
  Классы: нет
  Функции: `cart_service`, `test_topup_really_buys_traffic_from_saved_cart`, `test_topup_really_buys_devices_from_saved_cart`, `test_button_really_buys_traffic_and_says_so`, `test_button_really_buys_devices_and_says_so`, `test_partial_topup_keeps_cart_and_intent`
